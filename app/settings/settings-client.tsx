...
export function SettingsClient({ settings: initialSettings, pricing: initialPricing, isGoogleConnected, googleStatus, isFrameioConnected, frameioStatus }: {
  settings: any
  ...
  const [activeTab, setActiveTab] = useState<'business' | 'pricing' | 'addons' | 'shoot' | 'integrations'>(
    (googleStatus || frameioStatus) ? 'integrations' : 'business'
  )
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-gray-600">
                Connect your Google account to enable Gmail email threading and Google Drive footage management across all projects.
              </p>
              ...
              {isGoogleConnected ? (
                <div className="flex items-center justify-between rounded-lg border border-green-200 bg-green-50 px-4 py-3">
                  <div className="flex items-center gap-2 text-green-700">
                    <CheckCircle size={18} />
                    <span className="font-medium text-sm">Google connected (Gmail + Drive)</span>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
                  ...
                  <a href="/api/auth/google?origin=settings">
              ...
              <div className="rounded-lg border border-gray-100 bg-gray-50 p-4 space-y-2">
                ...
                <ul className="text-xs text-gray-500 space-y-1 list-disc list-inside">
                  <li>Add <code className="bg-white border border-gray-200 rounded px-1">GOOGLE_CLIENT_ID</code>, <code className="bg-white border border-gray-200 rounded px-1">GOOGLE_CLIENT_SECRET</code>, and <code className="bg-white border border-gray-200 rounded px-1">GOOGLE_REDIRECT_URI</code> to your <code className="bg-white border border-gray-200 rounded px-1">.env.local</code></li>
                  <li>Add <code className="bg-white border border-gray-200 rounded px-1">http://localhost:3000/api/auth/google/callback</code> as an authorized redirect URI in Google Cloud Console</li>
                  <li>Enable both the Gmail API and Google Drive API in your Google Cloud project</li>
                  <li>Label emails in Gmail with the exact project name to appear on the project Emails page</li>
                </ul>
              </div>
            </CardContent>
          </Card>
